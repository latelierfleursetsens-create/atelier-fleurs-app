...
export default {
  async fetch(request,env){
    ...
    if(request.method==="POST"&&url.pathname==="/test-email"){
      ...
      const quote={numero:"D-PROD-REMINDER",echeance:ymd,clientNom:String(data.name||"Test MyBusiness"),portalUrl:"https://latelierfleursetsens-create.github.io/atelier-fleurs-app/espace-client.html"};
