# MyBusiness V7.5.8 PROD — REFUSÉS / SANS SUITE
- **V7.5.8 PROD** : classement des fiches mariage qui n’aboutissent pas dans un onglet « Refusés / sans suite », avec motif, conservation de l’historique, réactivation possible et prise en compte du dernier devis non accepté dans l’analyse commerciale.
