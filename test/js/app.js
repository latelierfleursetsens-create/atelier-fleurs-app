/* V3.6.0 TEST MODULAIRE — CRM Mariage avec fiche en onglets. */
"use strict";

var APP_VERSION = "TEST V3.6.0 MODULAIRE";
var APP_VERSION_NOTE = "Version test : CRM Mariage avec navigation par onglets dans chaque fiche mariage.";
var APP_CHANGELOG = [
